...
const myBot = ['ueacedbe88bf6e2c5cf6188b3a4a26e18'];
...
\n";
        ...
        if(txt === 'จัดละนะ555' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'จัดละนะ555' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
